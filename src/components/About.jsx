  ...
  return (
    <section id="about" className="py-20 px-6 bg-black">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div>
            <h3 className="text-2xl font-light mb-4">The Essentialist</h3>
            ...
            <a 
              ...
              className="inline-flex items-center gap-2 mt-6 text-blue-500 hover:text-blue-400 transition-colors font-mono text-sm"
            >
              Visit Store →
            </a>
          </div>
